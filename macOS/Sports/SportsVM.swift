        ...
        Button(action: {
            ...
            VStack {
                ...
                .overlay(selection == sport.name ?
                         Circle().stroke(colorScheme == .light && NSColor(hexString: sport.color).luminance > 0.5 ? Color(NSColor(hexString: sport.color).shaded(amount: 0.15).saturated(amount: 0.15)) : Color(hexString: sport.color), lineWidth: 3)
